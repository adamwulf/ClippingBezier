...
template <class PointType, class CmpFunctor> typename PointType::value_type ccw( const PointType& p0, const PointType& p1, const PointType& p2, CmpFunctor& thetaCmp )
{
    ...
    typename PointType::value_type __attribute__((unused)) theta0( thetaCmp(p0) );
    typename PointType::value_type __attribute__((unused)) theta1( thetaCmp(p1) );
    typename PointType::value_type __attribute__((unused)) theta2( thetaCmp(p2) );
